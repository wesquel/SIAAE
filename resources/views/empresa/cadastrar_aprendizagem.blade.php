        ...
        <div class="divisao-inputs">
            <div class="col ladoesq" id="conteudoesq">
                <div id="linha-vertical">
                    ...
                    <div class="div-ch">
                        <input class="espacamento-inputs form-control chpratica-input" name="CHPratica" type="number" min="0" placeholder="Carga Horária Prática">
                        <input class="espacamento-inputs form-control chteorica-input" name="CHTeorica" type="number" min="0" placeholder="Carga Horária Teórica">
                    </div>
                    <div class="div-data">
