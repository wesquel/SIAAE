        ...
        <form method="POST" action="{{route('cadastrar.vaga.estagio', ["inclusao" => $inclusao])}}">
            ...
            <div class="divisao-inputs">
                <div class="col ladoesq" id="conteudoesq">
                    <div id="linha-vertical">
                        ...
                        <div class="div-bolsa next-input-siaae">
                            <div class="group meio-input-esq">
                                <span class="checkBox-input">
                                    <input id="checkBoxBolsa" name="checkBoxBolsa"
                                           @if(old('checkBoxBolsa') != "") checked @endif type="checkbox"/>
                                </span>
                                <input id="bolsa" name="bolsa" maxlength="10"
                                       class="input-siaae @error('bolsa') input-error-siaae @enderror"
                                       value="{{ old('bolsa') }}" @if(old('checkBoxBolsa') == "") disabled @endif>
                            ...
                            <div class="group meio-input-dir">
                                <select multiple id="Auxilios" name="auxilios[]"
                                        class="espacamento-inputs select-siaae">
                        ...
                        <div class="div-turno next-input-siaae">
                            <div class="group meio-input-esq">
                                <input onfocus="(this.type='time')" id="hora" name="ch_semanal"
                                       class="time hora input-siaae @error('ch_semanal') input-error-siaae @enderror"
                        ...
                        <div class="div-data next-input-siaae">
                            <div class="group meio-input-esq">
                                <input name="data_inicio"
                                       class="date input-siaae @error('data_inicio') input-error-siaae @enderror"
                                       value="{{ old('data_inicio') }}" onfocus="(this.type='date')" required>
                            ...
                            <div class="group meio-input-dir">
                                <input name="data_fim"
                                       class="date input-siaae @error('data_fim') input-error-siaae @enderror"
                                       value="{{ old('data_fim') }}" onfocus="(this.type='date')" required>
                        ...
                        <div class="div-data next-input-siaae">
                            <div class="group meio-input-esq">
                                <input name="data_limite"
                                       class="date input-siaae @error('data_limite') input-error-siaae @enderror"
                                       value="{{ old('data_limite')}}" onfocus="(this.type='date')" required>
                            ...
                            <div class="group meio-input-dir">
                                <input name="vagas" maxlength="2"
                                       class="input-siaae @error('vagas') input-error-siaae @enderror"
                ...
                <div class="col ladodir" id="conteudodir">
                    <textarea name="pre_requisitos" placeholder="Pré-requisitos"
                              class="form-control desc-input text-area-vaga"></textarea>
                    <textarea name="atv_desempenhadas" placeholder="Atividades desempenhadas"
                              class="espacamento-inputs form-control desc-input text-area-vaga"></textarea>
                    <div>
                        <textarea name="desc" placeholder="Descrição da Vaga"
                                  class="espacamento-inputs form-control desc-input text-area-vaga-desc"></textarea>
                        <button type="submit" class="system-button system-button-verde botao-cadastrar-vaga">Publicar
                        </button>
                    </div>
                </div>
            </div>
