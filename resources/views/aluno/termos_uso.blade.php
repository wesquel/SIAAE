...
<body>
    <div class=e561_2333>
        ...
        <div class=e561_2343>
            <div class="e561_2344"></div>
            <span class="e561_2345">
                <input type="checkbox" id="horns" name="horns" class = "checkbox_t">
                Declaro que li e aceito os termos e politica de privacidade
            </span>
        </div>
        <a href="/home_aluno">
            <div class=button>
                <div class = "texto_button">Continuar</div>
             </div>
        </a>
    </div>
</body>
