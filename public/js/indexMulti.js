...
function loadDoc() {
    ...
    var elementos1 = document.getElementsByClassName("remove");
    if (elementos.length > 0 || elementos1.length > 0){
...
var drop = function(info){var o = {
    ...
    init: function(){
        ...
        this.html.icon = $.template('<span class="icon-multDrop"><i class="icon-multDrop"> </span>')
        this.html.iconDisplay = $.template('<div class="select-display">Icon Display</div>')
        ...
        this.html.drop.appendChild(this.html.icon)
        this.html.drop.appendChild(this.html.iconDisplay)
        ...
        this.html.iconDisplay.innerHTML = this.html.parent.getAttribute("Name");

        //Core Events
        var that = this;
        this.html.iconDisplay.on('click', function(){ that.toggle() });
